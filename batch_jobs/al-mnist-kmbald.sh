...
time python3 main.py -i -v --al -predst ~/.keras/datasets -split 0.857 0.013 0.13 -net BayesKNet -data MNIST -tnorm -init_train 20 -ac_steps 50 -dropout_steps 50 -ac_function km_uncert -un_function bayesian_bald -acquire 20 -k -e 50 -b 128 -out logs/ -cpu 4 -gpu 1 -f1 0 -tn -wpath results/$DIRID -model_dir results/$DIRID -logdir results/$DIRID
