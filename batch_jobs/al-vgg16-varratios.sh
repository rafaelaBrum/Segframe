...
time python3 main.py -i -v --al -predst $LOCAL/test/lym_cnn_training_data/ -split 0.9 0.05 0.05 -net BayesVGG16 -data CellRep -init_train 2000 -ac_steps 15 -dropout_steps 10 -ac_function bayesian_varratios -acquire 1000 -d -e 30 -b 96 -tdim 250 250 -out logs/ -cpu 9 -gpu 3 -tnorm -tn
