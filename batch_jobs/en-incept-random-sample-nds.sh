...
time python3 main.py -i -v --al -strategy EnsembleTrainer -predst /pylon5/ac3uump/alsm/data/active-learning/nds100 -split 0.85 0.05 0.10 -net Inception -data CellRep -init_train 500 -ac_steps 20 -emodels 3 -ac_function random_sample -acquire 200 -d -e 50 -b 60 -tdim 240 240 -out logs/ -cpu 9 -gpu 2 -tn -sv -nsw -wpath results/$DIRID -model_dir results/$DIRID -logdir results/$DIRID -cache results/$DIRID -sample 5000
