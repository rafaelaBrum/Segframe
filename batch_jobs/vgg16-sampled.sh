...
time python3 main.py -i -v --train -predst $LOCAL/test/lym_cnn_training_data/ -split 0.9 0.05 0.05 -net VGG16 -d -sample 0.05 -data CellRep -e 100 -b 64 -tdim 250 250 -out logs/ -cpu 9 -gpu 2 --pred -tnorm -tn
