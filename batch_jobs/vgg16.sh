...
time python3 main.py -i -v --train -predst $LOCAL/test/lym_cnn_training_data/ -split 0.9 0.05 0.05 -net VGG16 -data CellRep -e 25 -b 128 -out logs/ -cpu 6 -gpu 2 --pred -tn
